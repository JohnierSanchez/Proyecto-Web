 ...
 * 
 */
@WebServiceClient(name = "WS", targetNamespace = "http://webservices.services.co/", wsdlLocation = "http://localhost:8084/WebService/WS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WS_QNAME = new QName("http://webservices.services.co/", "WS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/WebService/WS?wsdl");
    ...
    public WS getWSPort() {
        return super.getPort(new QName("http://webservices.services.co/", "WSPort"), WS.class);
    }
    ...
    public WS getWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.services.co/", "WSPort"), WS.class, features);
    }
